...
int main(){
	...
	bool opcionValida=true, salir=false;
	//Menu Principal
	...
	do{
		...
		switch (secuenciaDeDecisiones[5]){
			case 'a':
				cout<<"Resulta ser otro detective. Tras una cuidadosa investigacion descubrio que tu secuestraste a Jane Doe"<<endl;
			break;
			case 'b':
				cout<<"Un excelente juego. Tu equipo suma una victoria. No resolviste el caso"<<endl;
			break;
			case 'e':
				salir=true;
			break;
